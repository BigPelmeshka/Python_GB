...
class Clothes(ABC):
    ...
    def consumption(self):
        return 'Сумма ткани равна: {:.2f}'.format(self.param/6.5+0.5+2*self.param+0.3)


class Coat(Clothes):
    def consumption(self):
        return 'Для пальто нужно: {:.2f} ткани'.format(self.param/6.5+0.5)

class Costume(Clothes):
    def consumption(self):
        return 'Для костюма нужно: {:.2f} ткани'.format(2*self.param+0.3)
